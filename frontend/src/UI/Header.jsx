...
export default function Header() {
	...
	const buttonStyles = "mt-5 bg-white p-3 flex gap-3 items-center";
	let button = (
		<Button className={buttonStyles} onClick={handleSignIn}>
			...
			<span className='text-black'>Sign in with Steam</span>
		</Button>
	);
	if (isAuthenticated) {
		button = (
	...
	return (
		<header className='flex flex-col'>
			<h1 className='text-center mt-3 text-3xl font-bold sm:text-4xl'>
				Steam Game Tracker
			</h1>
			{button}
		</header>
